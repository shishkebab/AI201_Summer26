...
**Final confusion matrix with optimized hyperparameters:**
...
**Initial confusion matrix with default hyperparameters:**
![initial confusion matrix](./confusion_matrix_default_param.png)
